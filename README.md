...
| 原表 | 改成 | 依据 |
|---|---|---|
| NP-F970 电池 | **NP-F550** | 上游文件名叫 f970 是误导，实测尺寸是 F550；F970 装不进去。[主仓 BOM 勘误](https://github.com/fanhao375/microduck-replica/blob/master/BOM.md) |
| XL330 ×4、HD1901M ×6 | **舵机 ×15**，XL330-M288 或飞特 HD-1910-C001 二选一 | 15 个关节：两腿各 5、颈头嘴 5。原表「13 单盘 + 2 双盘」的备注是对的 |
| imu_to_dxl 电路板 ×2 | **×1** | 总线上只有一块，ID 200 |
...
| 40 | 舵机线缆 | 若干 | 舵机自带，调试和分支要另买；飞特 2.0 mm、Dynamixel 2.5 mm |
| 41 | 电池 | 1 | **NP-F550**，2S |
